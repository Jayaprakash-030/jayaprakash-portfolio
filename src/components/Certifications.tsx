...
const certificationDescriptions: Record<string, { description: string[], logo: string }> = {
  'Oracle Cloud Infrastructure 2025 Certified Generative AI Professional': {
    description: [
      'Generative AI fundamentals and OCI services',
      'Applied LLM workflows and responsible AI practices'
    ],
    logo: '/oracle.png'
  },
  'Oracle AI Vector Search Certified Professional': {
    description: [
      'Vector search concepts, embeddings, and retrieval',
      'Building RAG-ready search pipelines on OCI'
    ],
    logo: '/oracle.png'
  }
};
